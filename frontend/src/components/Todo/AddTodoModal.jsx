...
const AddTodoModal = ({ isModalOpen, closeModal, edit = false, id = null }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!edit) {
      todosApi
        .addTodo({ title, description: desc })
        .then((res) => {
          closeModal();
          const customEvent = new CustomEvent("TodoUpdate", {
            detail: { ...res.data },
          });
      ...
      todosApi
        .updateTodo({ id, title, description: desc })
        .then((res) => {
          closeModal();
          const customEvent = new CustomEvent("TodoUpdate", {
            detail: { ...res.data },
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 w-screen h-screen ">
            ...
            >
              <Dialog.Panel className="rounded-md bg-white w-6/12">
                ...
                >
                  {edit ? <h1>Edit Todo</h1> : <h1>Create Todo</h1>}
                  <button
                    onClick={() => closeModal()}
